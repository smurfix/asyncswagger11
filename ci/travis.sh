...
if [ "$CHECK_FORMATTING" = "1" ]; then
    ...
    if ! yapf -rpd setup.py asyncswagger11; then
        cat <<EOF
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
Formatting problems were found (listed above). To fix them, run
   ...
   pip install yapf==${YAPF_VERSION}
   yapf -rpi setup.py asyncswagger11
...
if [ "$CHECK_DOCS" = "1" ]; then
    ...
    pytest -W error -ra -v --pyargs tests --cov=asyncswagger11 --cov-config=.coveragerc --verbose
